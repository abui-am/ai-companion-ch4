...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "TTSBenchmark", targets: ["TTSBenchmark"]),
        .executable(name: "RealtimePipeline", targets: ["RealtimePipeline"]),
        .executable(name: "SpeakerBenchmark", targets: ["SpeakerBenchmark"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .executableTarget(
            ...
            linkerSettings: [
                .unsafeFlags([
                    "-Xlinker", "-sectcreate", "-Xlinker", "__TEXT", "-Xlinker", "__info_plist",
                    "-Xlinker", "Sources/TTSBenchmark/Info.plist",
                ], .when(platforms: [.macOS])),
            ]
        ),
        .executableTarget(
