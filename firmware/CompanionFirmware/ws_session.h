...
// push-to-talk button and I2S audio I/O, and runs the session state
// machine. Call wsSessionBegin() once from setup(), then wsSessionLoop()
// from every Arduino loop() iteration (required by the WebSockets library
// to process incoming data and reconnects).
//
